        ...
        <div class="row d-flex flex-column">
            ...
            <div class="col-lg-12">
                <div class="">
                    ...
                    <p class="font-14 mt-3 ms-2"><img src="{{ asset('default_image/no-image-icon-23494.png') }}" width="100" height="100" class="">دفتر مرکزی : <span class="font-13">استان کرمان - شهرستان کرمان - خیابان بهشتی</span></p>
